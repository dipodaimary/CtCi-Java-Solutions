//package Chapter16Moderate.FindBestLine;
//
//
...
//        HashMap<Double, Line> linesBySlope = getListOfLines(points);
//        return getBestLine(linesBySlope);
//    }
//
//    /* Add each pair of points as a line to the list. */
//    public static HashMap<Double, Line> getListOfLines(GraphPoint[] points) {
//        HashMap<Double, Line> linesBySlope = new HashMap<Double, Line>();
...
//    public static Line getBestLine(HashMap<Double, Line> linesBySlope) {
//        Line bestLine = null;
//        int bestCount = 0;
//
...
//     */
//    public static int countEquivalentLines(HashMap<Double, Line> linesBySlope, Line line) {
//        double key = Line.floorToNearestEpsilon(line.slope);
